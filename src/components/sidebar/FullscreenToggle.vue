<template>
  <div>
    <button
      ...
      :class="{
        'bg-c-bluejay hover:bg-c-bluejay-light': isFullscreen,
    ...
    >
      ...
      }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-zinc-800 dark:text-zinc-200">
